...
############### NETWORK #################
#########################################
@RegisterModel('dl_vonmises_network')
class DialogueVonMisesNetwork(nn.Module):
	def __init__(self, args):
		super(DialogueVonMisesNetwork, self).__init__()
...
class DialogueClassifier(AbstractModel):
	...
	def vectorize(self, batch, mode = "train"):
		...
		bow_weights = FloatTensor(self.vocabulary.inverse_utterance_frequency[batch['utterance_bow_list']])
